...
// --------------------------------------------------------------------
void CEXPRESSION_OCT::optimization( CCOMPILE_INFO *p_info ) {
...
void CEXPRESSION_OCT::compile( CCOMPILE_INFO *p_info ) {
	...
	p_info->assembler_list.body.push_back( asm_line );
	asm_line.set( CMNEMONIC_TYPE::CALL, CCONDITION::NONE, COPERAND_TYPE::LABEL, "bios_fouto", COPERAND_TYPE::NONE, "" );
	p_info->assembler_list.body.push_back( asm_line );
